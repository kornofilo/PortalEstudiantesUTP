  ...
  <div class="container">
        ...
        <div class="view overlay">
                <img class="card-img-top" style="max-width: 350px;" src="/imagenes/bolsatrabajo/{{isset($imagen)?$imagen:null}}" alt="Card image cap">
                <a href="#!">
            ...
            <div class="card-body card-body-cascade shadow text-center " >
              ...
              <!-- Subtitle -->
              <h6 class="font-weight-bold indigo-text py-2">Ubicacion: {{isset($ubicacion)?$ubicacion:null}}</h6>
              <!-- Text -->
